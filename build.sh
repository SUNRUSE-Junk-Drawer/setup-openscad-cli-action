...
if [ "$(uname)" == "Darwin" ]; then
  ...
  sudo apt-get install libglew-dev libxmu-dev libxi-dev qt5-default qtmultimedia5-dev libboost-filesystem-dev libeigen3-dev libmpc-dev libqscintilla2-qt5-dev -y
